...
@OrderOn(0)
public class ApplicationEnvironmentFactory extends AbstractBootstrapFactory<String,Environment>{

	private static final String prefix_filepath = "filepath:";
	private static final String prefix_classpath = "classpath:";
	private static ApplicationEnvironmentFactory factory;
	
	@Assignable
	public static ApplicationEnvironmentFactory getFactory() {
		if(factory==null) {
			factory=new ApplicationEnvironmentFactory();
		}
		return factory;
	}
	
	@Override
	public ApplicationEnvironmentFactory loadFactory() {
		try {
